...
int main() {
     ...
     *
     * Difficulty/Length
     * p1 = Very easy ~ 20 min (this is just a copy paste from assignment one w/added functionality)
     * p2 = Honestly this one was pretty easy but took a significant amount of time for me to understand the quirks of overloading, but I can tell now how powerful it is.
     */
    return 0;
}